...
const CarBands = () => {
    return (
        <div className=" py-20 px-2 md:px-5 lg:px-10 xl:px-20">
            <h4 className=" text-center text-lg font-semibold text-[#FF444A] tracking-widest" data-aos="fade-up">POPULAR BRANDS</h4>
            ...
            <section className="mt-10">
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-5" data-aos="fade-up">
